            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    <form @submit.prevent="onSubmit">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com"
                                    v-model="phone"
                                    v-bind="phoneAttrs">
                        ...
                        <div class="flex -mx-3">
                            <!-- <div class="w-1/2 px-3 mb-5">
                                <label for="" class="text-xs font-semibold px-1">File</label>
                                <div class="flex">
